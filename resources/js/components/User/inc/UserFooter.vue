      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <div class="barnd-bg">
              <a href="#">
                <img src="/assets/public/img/brand/1.png" alt="Brand Logo" />
              </a>
              <a href="#">
                <img src="/assets/public/img/brand/2.png" alt="Brand Logo" />
              </a>
              <a href="#">
                <img src="/assets/public/img/brand/3.png" alt="Brand Logo" />
              </a>
              <a href="#">
                <img src="/assets/public/img/brand/4.png" alt="Brand Logo" />
              </a>
              <a href="#">
                <img src="/assets/public/img/brand/5.png" alt="Brand Logo" />
              </a>
            </div>
          </div>
        </div>
              ...
              <div class="single-text">
                ...
                <div class="footer-menu">
                  <ul>
                    ...
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Top Sellers
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Manufactirers
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Suppliers
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Specials
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Availability
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              <div class="single-text">
                ...
                <div class="footer-menu">
                  <ul>
                    ...
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Fast Delivery
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Online Shopping
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Shipping Guide
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Turm Of Use
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="mdi mdi-menu-right"></i>Home Delivery
                      </a>
                    </li>
                  </ul>
                </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 text-right">
            <a href="#">
              <img src="/assets/public/img/footer/payment.png" alt />
            </a>
          </div>
        </div>
      </div>
