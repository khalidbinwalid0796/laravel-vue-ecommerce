...
class LoginController extends Controller
{
    ...
    */
    ...
    //jode ai controller ar vitore kono method na pai tokhon tarit a khoje
    ...
    //need to edit attemptLogin method to get admin details
    public function login(Request $request)
    {
        ...
        if ($this->attemptLogin($request)) {
            //nicher line ta add korte hobe admin ar details paoear jonno
            return response()->json($this->guard()->user());
            //$this->guard()->user() mane admin, karon niche guard ta admin kore diese
